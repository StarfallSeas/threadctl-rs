...
>`DeepSeek/P6.1-pkg-matcher.md` | 本文档记录：约束 → 实现 → 测试 → 性能 → 审查落地 → 冻结状态| 本文档记录：约束 → 实现 → 测试 → 性能 → 审查落地 → 冻结状态
...
| `DeepSeek/architecture.md` | P6.1 状态 + 时间线更新 |
| `DeepSeek/P6.1-pkg-matcher.md` | 本文档（三轮审查落地 + 冻结声明） |
